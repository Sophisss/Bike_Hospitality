...
const StackNavigator = () => {
  ...
  return (
    <Stack.Navigator 
      ...
      <Stack.Screen name="Login" component={LoginScreen} options={{ Title: translations[global.currentLanguage].login, headerShown: true }} />
      <Stack.Screen name="Register" component={RegisterScreen} options={{ Title: translations[global.currentLanguage].registration, headerShown: true }} />
