            ...
            <View style={homeStyle.body} keyboardShouldPersistTaps={'handled'}>    
                <ScrollView>
                    ...
                    <View style={homeStyle.touchableRow}>
                        <TouchableOpacity style={homeStyle.touchableRowItem} onPress={() => {navigation.navigate(urlHome)}}>
                        ...
                        <TouchableOpacity style={homeStyle.touchableRowItem} onPress={() => {navigation.navigate(urlComuni)}}>
                    ...
                    <View style={homeStyle.touchableRow}>
                        <TouchableOpacity style={homeStyle.touchableRowItem} onPress={() => {navigation.navigate(urlGuide)}}>
                        ...
                        <TouchableOpacity style={homeStyle.touchableRowItem} onPress={() => {navigation.navigate(urlTour)}}>
                    ...
                    <View style={homeStyle.touchableRow}>
                        <TouchableOpacity style={homeStyle.touchableRowItem} onPress={() => {navigation.navigate(urlStations)}}>
                        ...
                        <TouchableOpacity style={homeStyle.touchableRowItem} onPress={() => {navigation.navigate(urlEventi)}}>
                    ...
                    <View style={homeStyle.touchableRow}>
                        <TouchableOpacity style={homeStyle.touchableRowItem} onPress={() => {navigation.navigate(urlPartners)}}>
                        ...
                        <TouchableOpacity style={homeStyle.touchableRowItem} onPress={() => {navigation.navigate(urlFoodW)}}>
                    ...
                    <View style={homeStyle.touchableRow}>
                        <TouchableOpacity style={homeStyle.touchableRowItem} onPress={() => {navigation.navigate(urlNoleggio)}}>
                        ...
                        <TouchableOpacity style={homeStyle.touchableRowItem} onPress={() => {navigation.navigate(urlPromo)}}>
