...
function BottomBar() {
    ...
    return (
        ...
        <Tab.Navigator initialRouteName="Home" screenOptions={{
            ...
            <Tab.Screen name="Home" component={StackNavigator} options={{headerShown: false, tabBarLabel:  t[language].home, tabBarIcon: ({ color, size }) => (
                <MaterialCommunityIcons name="home" color={color} size={size} />
                )
            }} />
             
            <Tab.Screen name={urls.disciplinario.routeName} component={Disciplinario} options={{tabBarLabel:  label1, tabBarIcon: ({ color, size }) => (
                <MaterialCommunityIcons name="file" color={color} size={size} />
                ),
            }} />

            <Tab.Screen name="Collegamenti" component={Collegamenti} options={{tabBarLabel: t[language].collegamenti, tabBarIcon: ({ color, size }) => (
