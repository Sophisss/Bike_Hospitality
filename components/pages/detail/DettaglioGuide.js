...
function DettaglioGuide({ navigation, route }) {
  const { nome, cognome, provincia, comune, localita, foto, lingue, settori, telefono, email, descrizione } = route.params;
  ...
  return (
    <ScrollView showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false} contentContainerStyle={detailStyle.mainContainer} >
      ...
      <View style={detailStyle.sectionView}>
        <View style={detailStyle.flexDirectionRow}>
          <Text style={detailStyle.sectionTitle}>{"Lingue"}</Text>
          <Ionicons name={IconDecisionMaker('language')} style={detailStyle.sectionIcon} size={30} color='yellow'/>
        </View>
      ...
      <View style={detailStyle.sectionView}>
        <View style={detailStyle.flexDirectionRow}>
          <Text style={detailStyle.sectionTitle}>{"Settori"}</Text>
          <Ionicons name={IconDecisionMaker('list')} style={detailStyle.sectionIcon} size={30} color='white'/>
        </View>
