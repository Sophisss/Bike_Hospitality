...
import { _listEmptyComponent, geo } from '../../utilities/Utils';
...
function DettaglioStrutture({ navigation, route }) {
  const { nome, categoria, codice_provincia, email, localita, indirizzo, immagine, url, telefono, wiki, coords, descrizione } = route.params;
      ...
      <View style={detailStyle.mainContentView}>
        ...
        <View style={{flexGrow: 0, flexDirection: 'row', flex: 1, flexWrap: 'wrap', alignSelf: 'stretch', justifyContent: 'space-between'}}>
          ...
          >
            ...
            <Text style={[detailStyle.buttonText, detailStyle.buttonTextFlex]}>RAGGIUNGI LA DESTINAZIONE</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={{flexGrow: 0, flexDirection: 'row', flex: 1, flexWrap: 'wrap', alignSelf: 'stretch', justifyContent: 'space-between'}}>
          <TouchableOpacity style={[detailStyle.button, detailStyle.buttonFlex]} width={'auto'} onPress={() => 
            ...
            >
              ...
              <Text style={[detailStyle.buttonText, detailStyle.buttonTextFlex]}>SITO WEB</Text>
            </TouchableOpacity>
        </View>
      </View>
