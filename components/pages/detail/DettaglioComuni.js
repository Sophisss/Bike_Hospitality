...
function DettaglioComuni({ navigation, route }) {
  const { nome, provincia, codice_provincia, immagine, url, wiki, descrizione } = route.params;
  ...
  return (
    <ScrollView showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false} contentContainerStyle={detailStyle.mainContainer} >
      ...
      <View style={detailStyle.sectionView}>
        <View style={detailStyle.flexDirectionRow}>
          <Text style={detailStyle.sectionTitle}>{"Strutture Ricettive nella provincia di " + provincia}</Text>
      ...
      <View style={detailStyle.sectionView}>
        <View style={detailStyle.flexDirectionRow}>
          <Text style={detailStyle.sectionTitle}>{"Tour nella provincia di " + provincia}</Text>
